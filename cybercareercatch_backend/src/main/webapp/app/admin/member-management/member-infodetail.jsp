...
<meta charset="UTF-8">
<title>회원정보상세</title>
<link rel="stylesheet" href="../../../assets/css/admin/member-management/member-infodetail.css">
</head>
...
<button class="member-infodetail-logout">로그아웃</button>
...
<div class="member-infodetail-section-title">
회원 상세 정보
</div>
...
<div class="member-infodetail-update">
선호 직군 정보
</div>

<div class="member-infodetail-date-box">
모의해킹
</div>
