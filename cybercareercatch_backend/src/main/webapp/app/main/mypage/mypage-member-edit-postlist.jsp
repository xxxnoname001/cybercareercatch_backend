	...
	<main>
		<div class="main-container">
			...
			<div class="mypage-section">
				...
				<form action="${contextPath}/mypage/member/delete-my-qna.my" method="post">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="qna" items="${myQnaList}">
									<li class="mypage-QnAlist-content">
										<div class="check">
											<input type="checkbox" name="postNumbers" value="${qna.postNumber}">
										</div>

										<div class="no">${qna.postNumber}</div>

										<a href="${contextPath}/qna/detail.qna?postNumber=${qna.postNumber}"
											class="QnAlist-title">
											${qna.postTitle}
										</a>
										...
										<div class="answer-status ${qna.answerStatus eq '답변완료' ? 'answer-status-active' : ''}">
											${qna.answerStatus}
										</div>
									</li>
								</c:forEach>
