...
<body>
  <header class="header">
    <div class="header-inner">
      ...
      <div class="auth-area">
        <a href="${pageContext.request.contextPath}/mypage/mypage-company.jsp" class="auth-btn auth-btn--member" aria-label="마이페이지로 이동">
        ...
        <a href="${pageContext.request.contextPath}/mainpage/mainpage-logout.html" class="auth-btn auth-btn--logout">로그아웃</a>
      </div>
    </div>
  </header>
