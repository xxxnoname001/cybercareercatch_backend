...
<body>
    <header class="header">
        <div class="header-inner">
            ...
            <div class="auth-area">
                <a href="${pageContext.request.contextPath}/member/login.mefc" class="auth-btn">
                ...
                <a href="${pageContext.request.contextPath}/member/signup.mefc" class="auth-btn">회원가입</a>
            </div>
        </div>
    </header>
