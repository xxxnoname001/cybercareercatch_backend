...
public class CompanyCardDTO {
	...
	public String toString() {
		return "CompanyCardDTO [companyNumber=" + companyNumber + ", companyName=" + companyName + ", companyAddress="
				+ companyAddress + ", companyState=" + companyState + ", compPageDate=" + compPageDate + "]";
	}
}