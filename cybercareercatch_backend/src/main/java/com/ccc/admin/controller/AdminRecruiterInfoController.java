...
/*
 * 관리자 기업회원 정보 조회 목록 페이지로 이동시키는 컨트롤러이다.
 * 목록 조회, 검색, 페이징 처리를 담당한다.
 */
public class AdminRecruiterInfoController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		int total = adminDAO.getRecruiterListTotal(searchMap);
		...
		List<AdminMemberListDTO> recruiterList = adminDAO.selectRecruiterList(pageMap);
		...
		result.setPath("/app/admin/member-management/recruiter-info.jsp");
